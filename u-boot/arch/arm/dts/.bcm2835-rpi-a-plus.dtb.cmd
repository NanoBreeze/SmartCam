cmd_arch/arm/dts/bcm2835-rpi-a-plus.dtb := mkdir -p arch/arm/dts/ ; (cat arch/arm/dts/bcm2835-rpi-a-plus.dts; echo '$(pound)include "bcm283x-u-boot.dtsi"') > arch/arm/dts/.bcm2835-rpi-a-plus.dtb.pre.tmp; armv8-rpi3-linux-gnueabihf-gcc -E -Wp,-MD,arch/arm/dts/.bcm2835-rpi-a-plus.dtb.d.pre.tmp -nostdinc -I./arch/arm/dts -I./arch/arm/dts/include -Iinclude -I./include -I./arch/arm/include -include ./include/linux/kconfig.h -D__ASSEMBLY__ -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/dts/.bcm2835-rpi-a-plus.dtb.dts.tmp arch/arm/dts/.bcm2835-rpi-a-plus.dtb.pre.tmp ; ./scripts/dtc/dtc -O dtb -o arch/arm/dts/bcm2835-rpi-a-plus.dtb -b 0 -i arch/arm/dts/  -Wno-unit_address_vs_reg -Wno-unit_address_format -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-graph_port -Wno-unique_unit_address -Wno-simple_bus_reg -Wno-pci_device_reg -Wno-pci_bridge -Wno-pci_device_bus_num   -Wno-unit_address_vs_reg -Wno-unit_address_format -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-graph_port -Wno-unique_unit_address -Wno-simple_bus_reg -Wno-pci_device_reg -Wno-pci_bridge -Wno-pci_device_bus_num  -d arch/arm/dts/.bcm2835-rpi-a-plus.dtb.d.dtc.tmp arch/arm/dts/.bcm2835-rpi-a-plus.dtb.dts.tmp || (echo "Check /home/ubuntu/Desktop/smartcam/u-boot/arch/arm/dts/.bcm2835-rpi-a-plus.dtb.pre.tmp for errors" && false) ; cat arch/arm/dts/.bcm2835-rpi-a-plus.dtb.d.pre.tmp arch/arm/dts/.bcm2835-rpi-a-plus.dtb.d.dtc.tmp > arch/arm/dts/.bcm2835-rpi-a-plus.dtb.d ; sed -i "s:arch/arm/dts/.bcm2835-rpi-a-plus.dtb.pre.tmp:arch/arm/dts/bcm2835-rpi-a-plus.dts:" arch/arm/dts/.bcm2835-rpi-a-plus.dtb.d
