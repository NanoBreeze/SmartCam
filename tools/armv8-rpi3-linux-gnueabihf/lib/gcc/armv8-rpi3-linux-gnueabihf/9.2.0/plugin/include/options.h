...
enum opt_code
{
  ...
  OPT_minline_thumb1_jumptable = 1301,       /* -minline-thumb1-jumptable */
  ...
  OPT_shared_libphobos = 1373,               /* -shared-libphobos */
  ...
  OPT_static_libphobos = 1384,               /* -static-libphobos */
  OPT_static_libstdc__ = 1385,               /* -static-libstdc++ */
  OPT_static_libtsan = 1386,                 /* -static-libtsan */
  OPT_static_libubsan = 1387,                /* -static-libubsan */
  OPT_static_pie = 1388,                     /* -static-pie */
  /* OPT_std_c__03 = 1389, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1390, */                /* -std=c++0x */
  OPT_std_c__11 = 1391,                      /* -std=c++11 */
  OPT_std_c__14 = 1392,                      /* -std=c++14 */
  OPT_std_c__17 = 1393,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1394, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1395, */                /* -std=c++1z */
  OPT_std_c__2a = 1396,                      /* -std=c++2a */
  OPT_std_c__98 = 1397,                      /* -std=c++98 */
  OPT_std_c11 = 1398,                        /* -std=c11 */
  OPT_std_c17 = 1399,                        /* -std=c17 */
  /* OPT_std_c18 = 1400, */                  /* -std=c18 */
  /* OPT_std_c1x = 1401, */                  /* -std=c1x */
  OPT_std_c2x = 1402,                        /* -std=c2x */
  ...
  OPT_std_f2018 = 1410,                      /* -std=f2018 */
  OPT_std_f95 = 1411,                        /* -std=f95 */
  OPT_std_gnu = 1412,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1413, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1414, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1415,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1416,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1417,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1418, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1419, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1420,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1421,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1422,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1423,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1424, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1425, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1426,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1427, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1428,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1429,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1430, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1431, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1432,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1433, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1434, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1435, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1436, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1437, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1438,                     /* -std=legacy */
  OPT_symbolic = 1439,                       /* -symbolic */
  OPT_t = 1440,                              /* -t */
  OPT_time = 1441,                           /* -time */
  OPT_time_ = 1442,                          /* -time= */
  OPT_tno_android_cc = 1443,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1444,                 /* -tno-android-ld */
  OPT_traditional = 1445,                    /* -traditional */
  OPT_traditional_cpp = 1446,                /* -traditional-cpp */
  OPT_trigraphs = 1447,                      /* -trigraphs */
  OPT_u = 1448,                              /* -u */
  OPT_undef = 1449,                          /* -undef */
  OPT_v = 1450,                              /* -v */
  OPT_version = 1451,                        /* -version */
  OPT_w = 1452,                              /* -w */
  OPT_wrapper = 1453,                        /* -wrapper */
  OPT_x = 1454,                              /* -x */
  OPT_z = 1455,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
